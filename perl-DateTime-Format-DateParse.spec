...
cp %{_builddir}/DateTime-Format-DateParse-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-Format-DateParse/f235ba4160673bcb7c9d58c2f09dbc7fc0efadea || :
if test -f Makefile.PL; then
